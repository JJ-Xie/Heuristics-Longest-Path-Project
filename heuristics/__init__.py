...
from . import greedy, dfs_greedy, prune_central_edges, stretch_graph_periphery, stretch_lowest_vertex_periphery, stretch_graph_diameter
...
all = [
    ...
    stretch_lowest_vertex_periphery.stretch_nodes_longest_path,
...
run_stretch_lowest_node = stretch_lowest_vertex_periphery.stretch_nodes_longest_path
